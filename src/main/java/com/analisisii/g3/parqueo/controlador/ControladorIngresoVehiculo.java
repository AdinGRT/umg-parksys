...
import com.analisisii.g3.parqueo.vista.AgregarVehiculoDialog;
...
public class ControladorIngresoVehiculo implements ActionListener {
    ...
    public void generarTicket() {
        ...
        if (resultado == 1) {
            ...
            RegistroDeParqueo ultimoTicket = this.ticketDao.verUltimoTicket(this.vehiculo.getIdVehiculo());
            String vehiculo = "";
            if (idTipoVehiculo == 1) {
                vehiculo = "MOTO";
    ...
    public String mostrarTicket(RegistroDeParqueo ticket, String tipoVehiculo, String placa) {
